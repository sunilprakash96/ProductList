  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}>
        <TouchableOpacity styles={{  backgroundColor: 'red' }} onPress={() => props.navigation.navigate("Otp")}>
            <Image
      ...
      <View>
        <Text style={{ textDecorationStyle: "solid", color: "black"}}>Already registered? <Text style={{ fontSize: 20, textDecorationStyle: "solid", textDecorationLine: "underline", color: "black"}} onPress={() => props.navigation.navigate("Login")}>Login</Text></Text>
      </View>
